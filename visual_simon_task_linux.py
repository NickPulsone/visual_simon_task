# ~~~~~~~   work in progress   ~~~~~~~~
# usage: python visual_simon_task.py <# of stimuli/images> <#outfile_name>
import cv2
import csv
import screeninfo
...
TOTAL_STIMULI = argv[1]  # Number of stimuli for the test
A_KEY = 97  # ASCII "a" is 97
L_KEY = 108  # ASCII "l" is 108

# Filename and included path of each image of the arrows (can be changed if necessary)
...
def run_simon_task(delay, num_images, img_files, outfile_name):
    ...
    os.system("chmod 666 {}".format(sys.argv[2]))  # metawear python only runs with sudo
